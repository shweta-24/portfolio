...
function About() {
  return (
    <section id="about" className="py-10">
      ...
      Currently based in Philadelphia 🇺🇸, I’m endlessly curious, love solving real-world problems with tech, and 
      outside of work you’ll usually find me painting, throwing clay on a pottery wheel, or decoding 
